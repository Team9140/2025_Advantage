package org.team9140.frc2025.generated;
...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGainsMK4i =
      new Slot0Configs()
          .withKP(50.0)
          .withKI(0)
          .withKD(0.0) // 100, 0, 0
          .withKS((0.063954 + 0.022664) / 2.0)
          .withKV((2.719 + 2.7317) / 2.0)
          .withKA((0.34302 + 0.30008) / 2.0)
          .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);

  private static final Slot0Configs steerGainsMK4n =
      new Slot0Configs()
          .withKP(50.0)
          .withKI(0)
          .withKD(0.0) // 100, 0, 0
          .withKS((0.075051 + 0.15571) / 2.0)
          .withKV((2.3389 + 2.3426) / 2.0)
          .withKA((0.19043 + 0.17707) / 2.0)
          .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);

  // When using closed-loop control, the drive motor uses the control
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
  private static final Slot0Configs driveGainsMK4i =
      new Slot0Configs()
          .withKP(0.3)
          .withKI(0)
          .withKD(0)
          .withKS((0.17294 + 0.17162) / 2.0)
          .withKV((0.12071 + 0.12099) / 2.0)
          .withKA((0.0097394 + 0.0097698) / 2.0);

  private static final Slot0Configs driveGainsMK4n =
      new Slot0Configs()
          .withKP(0.3)
          .withKI(0)
          .withKD(0)
          .withKS((0.19322 + 0.19499) / 2.0)
          .withKV((0.1229 + 0.12215) / 2.0)
          .withKA((0.0073549 + 0.007025) / 2.0);
  ...
  private static final Current kSlipCurrent = Amps.of(69.0);
  ...
  public static final CANBus kCANBus = new CANBus("sigma", "./logs/example.hoot");
  ...
  private static final double kDriveGearRatioMK4i = 6.746031746031747 * 14.0 / 13.0;
  private static final double kSteerGearRatioMK4i = 150.0 / 7.0;
  ...
  private static final SwerveModuleConstantsFactory<
      ...
      ConstantCreatorMK4n =
          new SwerveModuleConstantsFactory<
              ...
              .withDriveMotorGains(driveGainsMK4n)
  ...
  private static final SwerveModuleConstantsFactory<
      ...
      ConstantCreatorMK4i =
          new SwerveModuleConstantsFactory<
              ...
              .withDriveMotorGains(driveGainsMK4i)
              .withSteerMotorClosedLoopOutput(kSteerClosedLoopOutput)
              .withDriveMotorClosedLoopOutput(kDriveClosedLoopOutput)
              .withSlipCurrent(kSlipCurrent)
              .withSpeedAt12Volts(kSpeedAt12Volts)
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.38818359375);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(0.20458984375);
